...
df = CSV.read("main_dat_processed.csv", DataFrame; ntasks=1)
...
Ĝ = MixtureModel( 
	Normal.(0.0,  [2.31884639801115;  0.00181566201062303;  2.36172342940965; 8.41454641279086]),
    Empirikos.fix_πs([0.209287481200937; 0.174883838893432; 0.428296630826899; 0.187532049078733])
)
...
CSV.write("confidence_intervals.csv", ci_dataframe)
...
density_targets_Ĝ = density_targets.(Ĝ)

# ╔═╡ 43e5e104-79a6-4fc5-af28-d170c94ee4f9
# ╠═╡ show_logs = false
density_targets_cis = confint.(floc_interval, density_targets)

# ╔═╡ 56f65b88-f32c-44bd-a43b-583e3112f0e9
begin
plot(zs_density, density_targets_Ĝ, color=:black,
	thickness_scaling = 1.4,
	grid = nothing,
	linewidth = 1.2,
    frame = :box,
...
Empirikos = "cab608d6-c565-4ea1-96d6-ce5441ba21b0"
...
[[deps.Empirikos]]
deps = ["CSV", "DataStructures", "Distributions", "Intervals", "JuMP", "KernelDensity", "LinearAlgebra", "LinearFractional", "LogExpFunctions", "MathOptInterface", "MultipleTesting", "ParameterJuMP", "QuadGK", "Random", "RangeHelpers", "RecipesBase", "Reexport", "Setfield", "SpecialFunctions", "Statistics", "StatsBase", "UnPack"]
git-tree-sha1 = "800b464674f960f2292b440457ec6b7b5d5ff053"
...
[[deps.LinearFractional]]
deps = ["JuMP", "MacroTools", "MathOptInterface"]
git-tree-sha1 = "c5a2aa8c0ec01468d556968ac9756774e0ee27ba"
...
git-tree-sha1 = "a7ea1d5263f9a3aa0670fbcc58c2cca275baa3fc"
...
[[deps.RangeHelpers]]
deps = ["LinearAlgebra"]
git-tree-sha1 = "2ae4ffbdac74828b7ff2fc0f962ca27a702631b7"
...
[[deps.oneTBB_jll]]
deps = ["Artifacts", "JLLWrappers", "Libdl"]
git-tree-sha1 = "f1dd5788210dae437db10a24ea0c660cf70d6412"
