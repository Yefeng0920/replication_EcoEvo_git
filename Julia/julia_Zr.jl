...
df = CSV.read("dat_processed_Zr.csv", DataFrame; ntasks=1)
...
Ĝ = MixtureModel( 
	Normal.(0.0,  [5.105718218;  2.148931249;  2.218443459; 28.40297755]),
    Empirikos.fix_πs([0.294232135; 0.00377407; 0.641289388; 0.060704408])
)
...
CSV.write("confidence_intervals_Zr.csv", ci_dataframe)
...
CSV.write("confidence_intervals_sample_size_multiplier_Zr.csv", ci_multiplier_dataframe)
